...
class PluginDeactivate
{
    ...
    public static function deactivate() {
        ...
        if ($success) {
            ...
            $msg = "<b>Sorry, can't let you disable Magic Convert!</b><br>" .
                ...
                'Please make your <i>.htaccess</i> writable and then try to disable MagicConvert again.<br>Alternatively, remove the rules manually in your <i>.htaccess</i> file and try disabling again.' .
            ...
            wp_redirect(admin_url('options-general.php?page=magic_convert_settings_page'));
            exit;
        }
    }
}
