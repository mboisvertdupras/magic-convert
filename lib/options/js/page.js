...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // (AVIF quality / encoding speed / converter stack now live in their own always-visible "AVIF"
    // section — see options/conversion-options/avif-converters.inc — so there is no reveal toggle to
    // wire here. The Formats panel keeps only the AVIF enable checkbox.)
