...
function openDeleteLogFilesPopup() {
    ...
    html += '<p>' +
      'The log files are btw located in <i>wp-content/magic-convert/log/</i>, if you want to have a closer look.' +
    '</p>';
...
function purgeLog() {
    var data = {
        'action': 'magicconvert_purge_log',
        'nonce' : window.magicConvert['ajax-nonces']['purge-log'],
    };
